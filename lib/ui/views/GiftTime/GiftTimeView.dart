...
import 'package:gogame/ui/views/GiftTime/GiftTimeViewModel.dart';
...
class _GiftViewState extends State<GiftView>
  ...
  Widget build(BuildContext context) {
    return ViewModelProvider<GiftViewModel>.withConsumer(
      onModelReady: (model) {},
      viewModel: GiftViewModel(context),
  ...
  Widget _getBody(GiftViewModel model) {
    return Stack(
      children: <Widget>[
        //Actual widget data
  ...
  Widget _getBaseContainer(GiftViewModel model) {
    return Stack(
      children: [
        Container(
