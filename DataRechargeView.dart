...
class DataRechargeView extends StatefulWidget {
  @override
  _DataRechargeViewState createState() => _DataRechargeViewState();
}

class _DataRechargeViewState extends State<DataRechargeView>
  ...
  Widget build(BuildContext context) {
    return ViewModelProvider<DataRechargeViewModel>.withConsumer(
      onModelReady: (model) {},
      viewModel: DataRechargeViewModel(context),
  ...
  Widget _getBody(DataRechargeViewModel model) {
    return Stack(
      children: <Widget>[
        //Actual widget data
  ...
  Widget _getBaseContainer(DataRechargeViewModel model) {
    return Stack(
      children: [
        Container(
